...
std::tuple<jlcxx::ArrayRef<double, 2>, jlcxx::ArrayRef<double, 1>, jlcxx::ArrayRef<double, 2>> PlanWithSST(const std::string obsFile, const std::string endpointsFile, const double angleBias = 0.0, const double solveTime = 10.0);
